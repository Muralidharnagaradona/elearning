...
public class RegasteacherPOM {
	private WebDriver driver; 
	
	public RegasteacherPOM(WebDriver driver) {
		this.driver = driver; 
	...
	//Below methods are used to send information in all the required fields in Teachers registration page
